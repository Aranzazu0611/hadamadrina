...
const { user_saved, name_table_user, user_updated, message_delete_not_exist, message_delete_error, user_login, user_not_found } = require("../utils/utils");
...
router.post('/api/user/auth', async(req, res, next) => {
        ...
        const info = req.body;        
        const {email, password, volunteers_rol} = info        

        await operation_insert(mysqlConnection,select_an_user_whith_param_query , [email, password,volunteers_rol], user_login, user_not_found, res)
        req.session.email= email;
        req.session.password = password;
        req.session.volunteers_rol = volunteers_rol;
...
router.post("/api/user/register", async(req, res) => {
    ...
    try {
        ...
        await operation_insert(mysqlConnection, insert_user_query, info, user_saved,user_not_found, res)
